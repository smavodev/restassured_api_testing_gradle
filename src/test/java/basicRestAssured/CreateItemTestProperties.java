...
public class CreateItemTestProperties {

    String USERNAME = ConfigProperties.getValue("create.username");
    String PASSWORD = ConfigProperties.getValue("create.password");
    String BASE_URL = ConfigProperties.getValue("api.base_url");
